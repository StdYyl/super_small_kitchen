    ...
    <div class="main" v-if="activeName=='first'">
      ...
      <div class="main_list">
        <el-table
          ...
          <el-table-column label="商品封面" min-width="120" :align="'center'">
            <template slot-scope="scope">
              <img :src="'./../../../static/images/role_member.png'" alt="">
            </template>
          </el-table-column>
          <el-table-column prop="goodsName" label="商品名称" min-width="250">
          </el-table-column>
          <el-table-column prop="goodsDescription" label="商品介绍" min-width="300">
          </el-table-column>
